...
{
    let firstTurn = parseInt(prompt('Яка відстань до першого поворота, км?', 2))
    let secondTurn = parseInt(prompt('Яка відстань до другого поворота, км?', 3))
    let finish = parseInt(prompt('Яка відстань до фініша, км?', 1))

    document.write(`Сумарна відстань, яку пролетів дрон складає - ${firstTurn+secondTurn+finish} км`)
}
